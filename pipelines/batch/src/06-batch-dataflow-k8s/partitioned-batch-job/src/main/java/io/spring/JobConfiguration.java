...
public class JobConfiguration {
	...
	@Bean
	public PartitionHandler partitionHandler(@Value("${spring.profiles.active}") String activeProfile,
											 TaskLauncher taskLauncher,
											 JobExplorer jobExplorer) throws Exception {
		//Resource resource = this.resourceLoader.getResource("maven://com.example:partitioned-batch-job:0.0.1-SNAPSHOT");
		Resource resource = new DockerResourceLoader().getResource("docker:jsa4000/dataflow-partitioned-batch-job:0.0.1-SNAPSHOT");
