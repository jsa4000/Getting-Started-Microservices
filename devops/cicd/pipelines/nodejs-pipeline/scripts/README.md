...
With the application running locally (with `npm run start`), export the necessary environment variables, and run the Python web experience test in this directory.
```bash
